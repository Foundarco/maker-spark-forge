...
const SOURCES: Source[] = [
  ...
  { table: "con_estimates", group: "Estimates", cols: ["title", "estimate_number", "scope"], title: (r) => `${r.estimate_number ? r.estimate_number + " · " : ""}${r.title}`, subtitle: (r) => `${r.status ?? ""} · $${Number(r.total || 0).toLocaleString()}`, link: () => ({ to: "/estimates" }) },
