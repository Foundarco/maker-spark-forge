...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Family-run general contractor since 1974. Custom homes, additions, renovations, and carpentry built with disciplined craftsmanship." },
      { property: "og:description", content: "Family-run general contractor since 1974. Custom homes, additions, renovations, and carpentry built with disciplined craftsmanship." },
      { name: "twitter:description", content: "Family-run general contractor since 1974. Custom homes, additions, renovations, and carpentry built with disciplined craftsmanship." },
